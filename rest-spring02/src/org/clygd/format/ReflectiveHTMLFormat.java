...
import org.clygd.util.ClassProperties;
import org.clygd.util.OwsUtils;
...
public class ReflectiveHTMLFormat extends DataFormat {
    ...
    private static final Logger LOGGER = Logger.getLogger("org.geoserver.rest");
