...
public class MyServerExtensions implements ApplicationContextAware ,ApplicationListener{
	
	static ApplicationContext context;
	
	static Map<Class,String[]> extensionsCache = new HashMap<Class, String[]>(40);
	static Map<Class,String[]> spiCache = new HashMap<Class, String[]>(40);

	@Override
	public void setApplicationContext(ApplicationContext context)
			throws BeansException {
		// TODO Auto-generated method stub
		MyServerExtensions.context = context;
	...
	public static final <T> List<T> extensions(Class<T> extensionPoint, ApplicationContext context) {
		...
		String[] names;
		if(MyServerExtensions.context == context){
