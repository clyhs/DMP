...
import org.clygd.format.MapJSONFormat;
import org.clygd.format.MapXMLFormat;
import org.clygd.resource.AbstractResource;
...
public abstract class MapResource extends AbstractResource {
     ...
     * logger
     */
    protected static Logger LOG = Logger.getLogger("org.geoserver.rest");
    ...
    public void handlePost() {
        ...
        Map map = null;
			...
			map = (Map) format.toObject(getRequest().getEntity());
