...
import org.clygd.format.ReflectiveHTMLFormat;
import org.clygd.format.ReflectiveJSONFormat;
import org.clygd.format.ReflectiveXMLFormat;
import org.clygd.rest.RestletException;
...
public abstract class ReflectiveResource extends AbstractResource {
     ...
     * logger
     */
    static Logger LOG = Logger.getLogger("org.clygd.rest");
