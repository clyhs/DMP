...
public interface HbaseOperations {
	...
	<T> T find(String tableName, final Scan scan, final ResultsExtractor<T> action, final int nStart, final int nOffset);
	...
	<T> List<T> find(String tableName, final Scan scan, final RowMapper<T> action, final int nStart, final int nOffset);
