...
keel.UploadPanel = function(cfg){
	...
	this.setting = {
		...
		post_params : this.postParams||{filePath:''},
	...
	keel.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			...
			{text:'上传',ref:'../uploadBtn',iconCls:'fileUp',handler:this.startUpload,scope:this},'-',
			{text:'停止上传',ref:'../stopBtn',iconCls:'close',handler:this.stopUpload,scope:this,disabled:true},'-',
			{text:'删除所有',ref:'../deleteBtn',iconCls:'del',handler:this.deleteAll,scope:this},'-'
		],
		layout : 'fit',
		items : [this.gp],
		listeners : {
